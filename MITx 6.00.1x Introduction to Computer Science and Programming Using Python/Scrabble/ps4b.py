...
##
# compChooseWord(hand, wordList, n) => bestword
# compPlayHand(hand, wordList, n) => create a piece of play
##
    ...
    while True:
        ...
        if response=="n":
            ...
            while playerFlag==True:
                responsePlayer=input("Enter u to have yourself play, c to have the computer play:")
                if responsePlayer=="u":
                    playHand(newHand, wordList, HAND_SIZE)
                    playerFlag=False
                elif responsePlayer=="c":
