...
print("Tent list after init:", c.get_tents())

#test case 1
#True
print("test case 1")
c.add_tent(Location(2,3))
print("Tent list after location 2,3:", c.get_tents())
...
print("")
print("remove test")
c.remove_tent(Location(1,2))
print("Tent list:", c.get_tents())